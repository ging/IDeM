...
class Presentation < ActiveRecord::Base
      ...
      myxml.general do
        ...
        myxml.description do
          if ejson["description"]
            ...
            myxml.string(ejson["title"] + ". A Virtual Presentation provided by " + IDeM::Application.config.full_domain + ".", :language=> metadataLanguage)
          else
            myxml.string("Virtual Presentation provided by " + IDeM::Application.config.full_domain + ".", :language=> metadataLanguage)
          end
        end
  ...
  def inferLanguage
    unless IDeM::Application.config.APP_CONFIG["languageDetectionAPIKEY"].nil?
