class HomeController < ApplicationController
  ...
  def index
    ...
    @publications = RecommenderSystem.suggestions({:n => 20, :user_profile => current_user_profile, :settings => {:database => "Loop", :preselection_filter_by_resource_types => ["Publication"]}})
  end
